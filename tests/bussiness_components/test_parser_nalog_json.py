...
def test_parse_organisation_id(bc_nalog_parser_json, exception_invalid_inn, catch_exception):
    """
...
def test_parse_accounting_id(bc_nalog_parser_json, exception_invalid_org_id, catch_exception):
...
def test_parse_accounting_json(bc_nalog_parser_json, exception_invalid_acc_id, catch_exception):
    """
...
def test_parse_accounting(bc_nalog_parser_json):
    """
